...
export default function GlobalError({
  ...
  useEffect(() => {
    console.error("Clinch Global Error Captured:", error);
  }, [error]);
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <title>System Error — Clinch</title>
          ...
          <div className="error-card" style={{
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                ...
                <span style={{ fontSize: "11px", fontWeight: 700, color: "#E8F2FC", letterSpacing: "0.09em", marginLeft: "8px" }}>GLOBAL SYSTEM ERROR</span>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#ef4444" }} />
                <span style={{ fontSize: "10px", color: "#ef4444", fontWeight: 600 }}>FATAL 500</span>
              </div>
            </div>
            ...
            <div style={{ padding: "36px 32px", display: "flex", flexDirection: "column", alignItems: "center" }}>
              ...
              <div style={{
                ...
                <ShieldAlert size={14} /> Critical Failure
              </div>
              ...
              <p style={{
                ...
                The core layout layer of Clinch has encountered a critical system interruption. Rest assured, your data is secure, and we are working to restore audio systems immediately.
              </p>
              ...
              <div style={{ display: "flex", gap: "12px", justifyContent: "center", width: "100%", marginBottom: "28px", flexWrap: "wrap" }}>
                <button onClick={handleRetry} className="btn-primary" style={{ fontSize: "14px", padding: "11px 22px", border: "none", display: "inline-flex", alignItems: "center", gap: "8px" }}>
                  <RefreshCw size={15} style={{ animation: "spin 4s linear infinite" }} /> Reconnect Core Systems
                </button>
                ...
                {showDetails && (
                  <div style={{
                    ...
                    <div style={{ background: "#0a1520", padding: "10px 12px", borderRadius: "4px", border: "1px solid #142435", fontSize: "12px", color: "#a5b9cc", fontFamily: "monospace", overflowX: "auto", whiteSpace: "pre-wrap", wordBreak: "break-all", maxHeight: "120px" }}>
                      {error.message || "A fatal layout-level runtime error occurred."}
                    </div>
                  </div>
                )}
              </div>
