        ...
        <div id="advantage-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "72px", alignItems: "center" }}>
          ...
          <div>
            ...
            <h2 style={{
              ...
              Like having a top producer coaching you — on every single call.
            </h2>
            <p style={{ fontSize: "15px", color: "#4a6070", lineHeight: 1.72, marginBottom: "32px" }}>
              While you&apos;re talking to a prospect, Clinch is listening too — silently, in the background. The moment you hit an objection, Clinch surfaces the exact rebuttal. The moment you forget a compliance disclosure, Clinch reminds you. The moment the close is near, Clinch prompts you to ask. Trained on thousands of hours of teaching from the industry&apos;s top closers so every call feels like you have a mentor in your ear.
            </p>
