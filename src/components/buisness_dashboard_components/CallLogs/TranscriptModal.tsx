          ...
          {isLoading ? (
            ...
            <div className="p-8 flex flex-col gap-8">
              ...
              <div className="grid grid-cols-2 gap-y-6">
                ...
                <div className="flex flex-col gap-1.5">
                  <span className="text-[13px] font-semibold text-[#0C1824]">Status</span>
                  <span className="text-[14px] text-[#64748B]">{data.status}</span>
                </div>
                <div className="flex flex-col gap-1.5">
                  <span className="text-[13px] font-semibold text-[#0C1824]">Call Outcome</span>
                  <span className="text-[14px] text-[#64748B]">{data?.outcome ?? "N/A"}</span>
                </div>
              </div>
